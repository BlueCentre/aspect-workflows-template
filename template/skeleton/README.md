...
To create a Backstage template, regenerate with the `backstage` flag enabled —
e.g. choose a `backstage-<lang>` preset (such as `backstage-py`) when running
`aspect init`.
{%- endif %}
